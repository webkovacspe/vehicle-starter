...
import hu.kovacspeterzoltan.bootcamp.vehicleregister.VehicleRegister;
import hu.kovacspeterzoltan.bootcamp.vehicleregister.storage.VehicleRegisterStorage;

public class Main {
    public static void main(String[] args) {
        VehicleRegister registerInteractor = new VehicleRegister();

        VehicleRegisterStorage persistenceStorageCSV = new PersistenceStorageCSV();
